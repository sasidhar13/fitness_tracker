...
print("Basic f",len(basic_features))
print("square f",len(square_features))
print("pca f",len(pca_features))
print("time f",len(time_features))
print("Freq f",len(frequency_features))
print("Cluster f",len(cluster_features))
...
#we got best results from simple model with lot of features
...
#------try with different models and different feature set
#         |
#        \/
